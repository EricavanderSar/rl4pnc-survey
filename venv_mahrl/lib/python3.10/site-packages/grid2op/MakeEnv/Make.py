...
TEST_DEV_ENVS = {
    ...
    "rte_case5_example_train": DEV_DATASET.format("rte_case5_example_train"),
    "rte_case5_example_val": DEV_DATASET.format("rte_case5_example_val"),
    "rte_case5_example_test": DEV_DATASET.format("rte_case5_example_test"),
    ...
    "l2rpn_case14_sandbox_diff_grid": DEV_DATASET.format(
...
def _force_test_dataset():
    ...
    if _VAR_FORCE_TEST in os.environ:
        try:
            ...
            warnings.warn(
                f"The environment variable {_VAR_FORCE_TEST}, "
...
def make(
    ...
    **NB** the first time you type this command, the dataset (approximately 300 MB for this one) will be
    ...
    if _force_test_dataset():
        if not test:
            warnings.warn(
                f'The environment variable "{_VAR_FORCE_TEST}" is defined so grid2op will be forced in "test" mode. '
    ...
    if dataset is None:
        raise Grid2OpException(
            "Impossible to create an environment without its name. Please call something like: \n"
